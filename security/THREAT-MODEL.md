...
| ID  | S   | Threat                                                                                                                                                                                                                  | Sev    |
| --- | --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| T01 | S   | Origin IP discovered (historical DNS, certificate transparency, an outbound connection from the box) and requested directly, bypassing WAF, bot management, per-IP rate limits, and the maintenance worker in one move. | High   |
