---
# Fixture: a stray `---` before the second entry. It renders as a horizontal
# rule in review, and before 2026-07-29 it truncated the frontmatter so the
# entries after it were never validated, at exit 0.
